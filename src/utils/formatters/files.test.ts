...
describe("utils->Formatters.bytes", () => {
  ...
  it("Return filename without extension", () => {
    ...
    expect(fileWithoutExtension("noExtensionFile.extens")).toEqual("noExtensionFile");
  ...
  it("Return value if the fileName has no extension if has (.) in the name", () => {
    ...
    expect(fileWithoutExtension("noExtension.File.extens")).toEqual("noExtension.File");
